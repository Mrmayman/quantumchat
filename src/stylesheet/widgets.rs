...
impl widget::container::Catalog for Theme {
    type Class<'a> = widget::container::StyleFn<'a, Theme>;

    fn default<'a>() -> <Self as widget::container::Catalog>::Class<'a> {
        Box::new(Self::style_container_normal)
    }

    fn style(&self, style: &widget::container::StyleFn<'_, Theme>) -> widget::container::Style {
        style(self)
    }
}
...
impl widget::button::Catalog for Theme {
    type Class<'a> = widget::button::StyleFn<'a, Theme>;
    ...
    fn style(
        &self,
        style: &widget::button::StyleFn<'_, Theme>,
...
impl widget::text::Catalog for Theme {
    type Class<'a> = widget::text::StyleFn<'a, Theme>;
...
impl widget::pick_list::Catalog for Theme {
    type Class<'a> = ();
...
impl widget::overlay::menu::Catalog for Theme {
    type Class<'a> = ();
...
impl widget::scrollable::Catalog for Theme {
    type Class<'a> = widget::scrollable::StyleFn<'a, Theme>;
    ...
    fn style(
        &self,
        style: &widget::scrollable::StyleFn<'_, Theme>,
...
impl widget::progress_bar::Catalog for Theme {
    type Class<'a> = ();
...
impl widget::slider::Catalog for Theme {
    type Class<'a> = ();
...
impl widget::checkbox::Catalog for Theme {
    type Class<'a> = widget::checkbox::StyleFn<'a, Theme>;
...
impl widget::text_editor::Catalog for Theme {
    type Class<'a> = widget::text_editor::StyleFn<'a, Theme>;

    fn default<'a>() -> <Self as widget::text_editor::Catalog>::Class<'a> {
        Box::new(Theme::style_text_editor_box)
    }
...
impl widget::radio::Catalog for Theme {
    type Class<'a> = widget::radio::StyleFn<'a, Theme>;
...
impl widget::rule::Catalog for Theme {
    type Class<'a> = widget::rule::StyleFn<'a, Theme>;

    fn default<'a>() -> Self::Class<'a> {
        Box::new(Theme::style_rule_default)
    }

    fn style(&self, style: &widget::rule::StyleFn<'_, Theme>) -> widget::rule::Style {
        style(self)
    }
}

impl widget::combo_box::Catalog for Theme {}

impl widget::pane_grid::Catalog for Theme {
    type Class<'a> = ();
