...
pub const HALLOWEEN: Palette = Palette {
    extra_dark: [0x1a, 0x0a, 0x0a],
    dark: [0x2d, 0x14, 0x14],
    second_dark: [0x4a, 0x20, 0x20],
    mid: [0xd9, 0x45, 0x00],
    second_light: [0xff, 0xb0, 0x60],
    light: [0xff, 0xdd, 0xaa],
    white: [0xff, 0xf2, 0xd9],
};
...
pub const ADWAITA_DARK: Palette = Palette {
    ...
    // maybe make these 2 *slightly* distinct?
    light: [0xff, 0xff, 0xff],
    white: [0xff, 0xff, 0xff],
};

pub const ADWAITA_LIGHT: Palette = Palette {
    extra_dark: [0xfa, 0xfa, 0xfb],
    dark: [0xeb, 0xeb, 0xed],
    second_dark: [0xd8, 0xd8, 0xdb],
    mid: [0x91, 0x91, 0x92],
    second_light: [0x40, 0x40, 0x44],
    light: [0, 0, 6],
    white: [0; 3],
};
